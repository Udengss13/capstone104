...
if(count($_POST)>0) {
$result = mysqli_query($con,"SELECT *from usertable WHERE id= $user_id");
$row=mysqli_fetch_array($result);
if($_POST["currentPassword"] == $row["password"] && $_POST["newPassword"] == $_POST["confirmPassword"] ) {
mysqli_query($con,"UPDATE usertable set password='" . $_POST["newPassword"] . "' WHERE id=$user_id");
                    ...
                    <form method="post" action="">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-6">
                                ...
                                <a href="userprofile.php" class="mb-5  btn btn-success text-light">Back</a>
                            </div>
                        </div>
