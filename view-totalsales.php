    ...
    <div class="card">
        ...
        <div class="card-body">
            <?php 
                                ...
                                ?>
            <button type="button" class="btn btn-primary mb-3" onclick="PrintElem('order-content','Order List')"><span
                    class="fa fa-print"></span>
                Print</button>
            <div class="table-responsive" id="order-content">
                <table id="example" class="table table-bordered table table-striped table-hover">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Product</th>
