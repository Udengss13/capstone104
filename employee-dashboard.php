...
<?php
            ...
            if($count==1){
                $service_content .= '<a class="nav-link active bordered" id="v-pills-'.$row_service['service_id'].'-tab" data-toggle="pill" href="#v-pills-'.$row_service['service_id'].'" role="tab" aria-controls="v-pills-home" aria-selected="true">'.$row_service['service_name'].'</a>';
                $service_desc .= '<div class="tab-pane fade show active shadow" id="v-pills-'.$row_service['service_id'].'" role="tabpanel" aria-labelledby="v-pills-'.$row_service['service_id'].'-tab">'.$row_service['description'].'</div>';
            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div class=" row  mt-5 mb-5 ml-5" align="center">
                    ...
                    <div class="col-md-8 justify-content-center mx-auto">
                        <ul class="nav nav-pills mb-3 shadow text-dark" id="pills-tab" role="tablist">
...
<!-- About us -->
<section class="flex-sect" id="about">
    <section id="imagesection" class="div_background_light py-4">
        <div class="container-fluid px-5 ">
            <div class="col-lg-12 col-md-12">
                <div class="justify-content-center row col-md-12 rounded-3">
                    <div style="width: 100%; height: 30px; border-bottom: 2px solid white; text-align: center">
                        <span style="font-size: 40px; s">
                            ABOUT US
                            <!--Padding is optional-->
                        </span>
                    </div>
