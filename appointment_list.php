            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="false">Served</button>
                            <button class="nav-link" id="cancelled-contact-tab" data-bs-toggle="tab"
                                data-bs-target="#cancelled-contact" type="button" role="tab"
                                aria-controls="cancelled-contact" aria-selected="false">Cancelled</button>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="table-responsive mt-4">
                                <table id="pending" class="table table-hover table-bordered" width="98%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-2">
                                            <a class="btn btn-sm btn-info approved"
                                                data-id="<?php echo $row_pending['id']; ?>"><span
                                                    class="fa fa-thumbs-o-up" data-bs-toggle="tooltip"
                                                    data-bs-placement="bottom" title="Approve"></span></a>
                                            <a class="btn btn-sm btn-danger cancel"
                                                data-id="<?php echo $row_pending['id']; ?>"><span
                                                    class="fs-5 fa fa-times" data-bs-toggle="tooltip"
                                                    data-bs-placement="bottom" title="Cancel"></span></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </table>
                            ...
                            <div class="table-responsive mt-4">
                                <table id="approve" class="table table-hover table-bordered" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo date('F d,Y h:ia',strtotime($row_approved['appoint_date'].' '.$row_approved['appoint_time'])); ?>
                                        </td>
                                        <td><?php echo $row_approved['customer_name']; ?></td>
                                        <td><?php echo $row_approved['petname']; ?></td>
                                        <td><?php echo $row_approved['service']; ?></td>
                                        <td>
                                            <a class="btn btn-sm btn-success serve"
                                                data-id="<?php echo $row_approved['id']; ?>"><span class="fa fa-check"
                                                    data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    title="Served"></span></a>
                                            <a class="btn btn-sm btn-danger cancel"
                                                data-id="<?php echo $row_approved['id']; ?>"><span
                                                    class="fs-5 fa fa-times" data-bs-toggle="tooltip"
                                                    data-bs-placement="bottom" title="Cancel"></span></a>
                                        </td>
                                    </tr>
                        ...
                        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                            ...
                            <table id="serve" class="table table-hover table-bordered" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo date('F d,Y h:ia',strtotime($row_serve['appoint_date'].' '.$row_serve['appoint_time'])); ?>
                                    </td>
                        ...
                        <div class="tab-pane fade" id="cancelled-contact" role="tabpanel"
                            aria-labelledby="cancelled-contact-tab">
                            <div class="table-responsive mt-4">
                                <table id="cancel" class="table table-hover table-bordered" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo date('F d,Y h:ia',strtotime($row_cancelled['appoint_date'].' '.$row_cancelled['appoint_time'])); ?>
                                        </td>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("appointment_list.php", {
                    approved_submit: 'approved_submit',
                    id: id
                }, function(data) {
                    location.reload();
                });
