                                    ...
                                    <li class="list-group-item" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4 ">
                                                ...
                                                <input type="date" name="appointdate" min="<?php echo date('Y-m-d'); ?>" class="form-control" required />
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
        ...
        $.post("reservation_list.php",function(data){
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventClick: function(info) {
                    ...
                    $.post("appointment_details.php",{id:reserve_id},function(data){
...
$(document).ready(function() {
    ...
    $(document).on('change', 'input[name="appointdate"]', function() {
        ...
        $.post("service_available_appointment.php", {
            service: service,appointdate:appointdate
        }, function(data) { 
            if(data!=1){
                 Swal.fire(
                    'Notice',
